...
public class Controller {
    ...
    public static StatusPernikahan getStatusPerkawinan(String status) {
        if (status.equalsIgnoreCase("BELUM MENIKAH")) {
            ...
            return StatusPernikahan.JANDA;
        } 
        else {
            return StatusPernikahan.DUDA;
        } 
    }
    ...
    public static KTP createKTP(String nik, String nama, String tempatLahir, String tanggalLahir, JenisKelamin jenisKelamin, String golDarah, String alamat, String rt, String rw, String kelDesa, String kecamatan,
            Agama agama, StatusPernikahan statusPernikahan, String pekerjaan, String kewarganegaraan, String wargaNegaraAsal, File photoFile, File signatureFile, String berlakuHingga, String kotaPembuatan, String tanggalPembuatan, int actionValue) {
        
        KTP ktp = new KTP(nik, nama, tempatLahir, tanggalLahir, jenisKelamin, golDarah, alamat, rt, rw, kelDesa, kecamatan,
                                agama, statusPernikahan, pekerjaan, kewarganegaraan, wargaNegaraAsal, photoFile,
